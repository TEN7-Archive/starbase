 ...
 * @endcode
 */
$settings['hash_salt'] = 'A326vdXYZ6wgaWKlTQrT4axUfTEamwfkB7b4v1EQthDHU-4FwT8cbHY5Fhp7MqjIuXMXvA3qLg';
...
elseif (file_exists('/.dockerenv') &&
  file_exists(dirname(__FILE__) . '/settings.local.docker.php')) {
  include dirname(__FILE__) . '/settings.local.docker.php';
}
elseif (file_exists('/.dockerenv') &&
  file_exists(dirname(__FILE__) . '/settings.docker.php')) {
  include dirname(__FILE__) . '/settings.docker.php';
}
elseif ($_SERVER['T7_SITE_ENVIRONMENT'] == 'preview' ||
  strpos(__FILE__, '/preview/src/')) {
  include dirname(__FILE__) . '/settings.preview.php';
}
elseif ($_SERVER['T7_SITE_ENVIRONMENT'] == 'release' ||
  strpos(__FILE__, '/release/src/')) {
  include dirname(__FILE__) . '/settings.release.php';
}
elseif ($_SERVER['T7_SITE_ENVIRONMENT'] == 'live' ||
  strpos(__FILE__, '/htdocs/')) {
